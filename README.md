...
First, configure your API key. Open the 配置API密钥.bat file. Please note that currently, only DeepSeek API keys are supported.
Then, launch the software by opening 启动软件.bat file.
